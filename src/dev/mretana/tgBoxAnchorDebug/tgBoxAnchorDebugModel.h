...
public: 
     ...
     */
    //const std::vector<tgBasicActuator*>& getAllActuators() const; remove act
...
private:
     ...
     * @param[in] s A tgStructure that we're building into
     */
    // static void addActuators(tgStructure& s); remove act
...
//private: remove act
     ...
     * through setup
     */
    //std::vector<tgBasicActuator*> allActuators; remove act
};
