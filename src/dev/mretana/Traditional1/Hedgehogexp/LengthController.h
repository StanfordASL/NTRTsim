...
class TensegrityHedgehogModel;

class LengthController : public tgObserver<TensegrityHedgehogModel>
{
public:
    ...
    virtual void onSetup(TensegrityHedgehogModel& subject);
     ...
     */
    virtual void onStep(TensegrityHedgehogModel& subject, double dt);
